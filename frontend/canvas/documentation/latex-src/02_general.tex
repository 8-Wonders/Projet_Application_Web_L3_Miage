...
Nous avons déjà réalisé le menu principal, qui figure dans le directoire \textit{menu} du repositoire. Ce module fera l'objet de légers ajustements avant son intégration définitive prévue pour la semaine prochaine.
