...
L'intégralité de la vision créative, incluant les idées originales, les mécaniques de jeu (système de compétences, gestion du tour par tour) et la structure globale du projet, a été planifiée et conçue par nos soins. L'intelligence artificielle a été sollicitée principalement pour la phase d'implémentation, générant une part significative du code source (classes, méthodes, logique de bas niveau) sur la base de nos spécifications.
