 ...
 * @property {('click'|'passive')} type - Designates whether the yield is applied manually or via the event loop.
 * @property {string} company - Vendor classification used for synergy calculations.
